#ifndef __INC_SLIM_DUAL_MODEL_HH__
#define __INC_SLIM_DUAL_MODEL_HH__
...
class SlimDualModel : public SlimProbabilityModel 
{
private:
  enum STATE {
    CPG_UP         =  0,
...
public:
  SlimDualModel() : SlimProbabilityModel(N_STATE, N_CPG_STATE, N_GAP_STATE) {}
  ~SlimDualModel() {}
